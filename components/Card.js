    ...
    render(){
        return(
            <Animatable.View animation={this.props.move} duration={1500} style={styles.cardone}>
                <TouchableOpacity style={styles.box1} onSubmit={this.props.screenchange}>
                ...
                <View style={styles.box2}>
                    ...
                    <Text style={{fontSize:15,color:'grey',letterSpacing:-0.5,paddingVertical:5}}>{this.props.subtitle}</Text>
                </View>
