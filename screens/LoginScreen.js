...
import {StyleSheet, View, Text, KeyboardAvoidingView, TextInput, TouchableOpacity, Image, Platform} from "react-native";
        ...
        {(props) => (
          <View style={styles.container}>
            ...
            <View style={styles.registerContainer}>
                ...
                <TouchableOpacity style={styles.SignUpButton} onPress={() => navData.navigation.navigate('Register')}>
